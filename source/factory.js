...
function createClient(remoteURL, { username, password, httpAgent, httpsAgent, token = null } = {}) {
  ...
  return {
    ...
    getDirectoryContentsRecursive: function getDirectoryContentsRecursive(remotePath, options) {
      const getOptions = merge(baseOptions, options || {});
      return directoryContents.getDirectoryContentsRecursive(remotePath, getOptions);
    },
    /**
